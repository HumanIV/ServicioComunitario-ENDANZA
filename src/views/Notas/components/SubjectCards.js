    ...
    return (
        <div className="animate__animated animate__fadeIn">
            <div className="d-flex align-items-center mb-5 px-2">
                ...
                <div>
                    <h3 className="mb-0 fw-bold text-dark">{grade.grado}</h3>
                    <p className="text-muted small mb-0 text-uppercase ls-1">Selecciona una materia para gestionar calificaciones</p>
                </div>
            </div>
                        ...
                        <CCard className="premium-card border-0 h-100 overflow-hidden shadow-sm hover-lift-sm">
                            <CCardHeader className="bg-orange-soft border-0 py-3 d-flex justify-content-between align-items-center">
                                <div className="d-flex align-items-center">
                                    ...
                                    <strong className="text-dark fw-bold text-uppercase ls-1" style={{ fontSize: '0.9rem' }}>{materia.nombre}</strong>
                                </div>
                            ...
                            <CCardBody className="p-4">
                                <CRow className="mb-4 g-3">
                                    <CCol xs={12} sm={6}>
                                        <div className="p-3 rounded-4 bg-light h-100 border border-light">
                                            <div className="text-muted small text-uppercase fw-bold ls-1 mb-2" style={{ fontSize: '0.6rem' }}>
                                                <CIcon icon={cilClock} className="me-1 text-primary" /> Horario
                                            </div>
                                            <div className="fw-bold text-dark small">{materia.horario}</div>
                                        </div>
                                    </CCol>
                                    <CCol xs={12} sm={6}>
                                        <div className="p-3 rounded-4 bg-light h-100 border border-light">
                                ...
                                <div className="p-4 rounded-4 bg-orange-soft border border-primary border-opacity-10">
                                            ...
                                            return (
                                                <div key={est.id} className="d-flex justify-content-between align-items-center">
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <span className="small text-dark fw-medium">{est.nombre}</span>
                                                    </div>
                            ...
                            <CCardFooter className="bg-transparent border-0 p-4 pt-0">
                                <CButton
                                    className="btn-premium w-100 py-2 d-flex align-items-center justify-content-center"
            ...
            <style>
                {`
                    ...
                    .hover-lift-sm:hover { transform: translateY(-5px); box-shadow: 0 15px 30px rgba(242, 140, 15, 0.1) !important; }
