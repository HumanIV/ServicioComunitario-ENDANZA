    ...
    return (
        <div className="mt-4 animate__animated animate__fadeIn">
                        ...
                        <CCardBody className="p-4">
                            ...
                            <div className="p-4 rounded-4 bg-orange-soft border border-primary border-opacity-10 mb-4">
                                <div className="d-flex justify-content-between align-items-center mb-3">
                                    <h6 className="text-primary small fw-bold text-uppercase ls-1 mb-0">Índice de Masa Coral (IMC)</h6>
            ...
            <style>{`
                ...
                .alert-custom { background-color: rgba(0, 123, 255, 0.05); }
                ...
                [data-coreui-theme="dark"] .alert-custom { background-color: rgba(0, 123, 255, 0.1); }
